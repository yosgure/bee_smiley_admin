// F_lead_detail_refactor (Phase 2): 旧リード詳細パネルの退避版。
// 新版 (`crm_lead_side_panel.dart`) で完全置換した。1 ヶ月運用後、問題なければ
// このファイルは物理削除予定。それまで参照禁止（無参照）。
// ignore_for_file: unused_element, unused_import, deprecated_member_use, unused_field, unused_local_variable

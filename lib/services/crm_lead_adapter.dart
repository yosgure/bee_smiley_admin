...
const Map<String, _KeyMap> _flatKeyMapping = {
  ...
  'childLastNameKana': _KeyMap(_Target.child, 'lastNameKana'),
  'childFirstNameKana': _KeyMap(_Target.child, 'firstNameKana'),
  ...
  'parentLastNameKana': _KeyMap(_Target.family, 'lastNameKana'),
  'parentFirstNameKana': _KeyMap(_Target.family, 'firstNameKana'),
...
Map<String, dynamic> flattenChildToLeadShape(
  ...
  final flat = <String, dynamic>{
    ...
    'childLastNameKana': child['lastNameKana'] ?? '',
    'childFirstNameKana': child['firstNameKana'] ?? '',
    ...
    'parentLastNameKana': family['lastNameKana'] ?? '',
    'parentFirstNameKana': family['firstNameKana'] ?? '',
    ...
    'kindergartenPhone': child['kindergartenPhone'],
    'homeroomTeacher': child['homeroomTeacher'],
    'hospitalName': child['hospitalName'],
    'hospitalPhone': child['hospitalPhone'],
    'doctorName': child['doctorName'],
    'severeSymptoms': child['severeSymptoms'],
    'sensitivities': child['sensitivities'],
    'precautions': child['precautions'],
    'childWishes': child['childWishes'],
    'familyWishes': child['familyWishes'],
    'troubles': child['troubles'],
    'familyComposition': child['familyComposition'],
    'permitStatus': child['permitStatus'],
    'mainConcern': child['mainConcern'],
    'mainConcernHearing': child['mainConcernHearing'],
    'likes': child['likes'],
    'likesHearing': child['likesHearing'],
    'dislikes': child['dislikes'],
    'dislikesHearing': child['dislikesHearing'],
    'medicalHistory': child['medicalHistory'],
    'medicalHistoryHearing': child['medicalHistoryHearing'],
    'diagnosis': child['diagnosis'],
    'diagnosisHearing': child['diagnosisHearing'],
    'grade': child['grade'],
    'trialAttendee': child['trialAttendee'],
